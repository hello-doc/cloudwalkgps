...
class CustomLogInterceptor extends QueuedInterceptorsWrapper {
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) {
    ...
    if (responseBody || response.data?['errorMessage'] != null) {
      logPrint('╔ Body');
      logPrint('║');
  ...
  String _getCurlRequest(RequestOptions options, {bool showInConsole = true}) {
    String result = '';
    ...
    try {
      ...
      LoggerApp.error('Error on create curl: $e');
    }
